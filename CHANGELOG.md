...
- Updates no longer fail on Windows with “Error opening file for writing: hookdeployed.exe”. The app now stops all sidecar processes (taps, connect, enroll) before the installer runs, with a confirmation when taps are active.
...
[Unreleased]: https://github.com/hookdeploy/hookdeploy-agent/compare/v0.1.4...HEAD
[0.1.4]: https://github.com/hookdeploy/hookdeploy-agent/compare/v0.1.3...v0.1.4
